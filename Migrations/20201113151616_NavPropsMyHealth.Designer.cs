...
namespace eDoc.Migrations
{
    ...
    [Migration("20201113151616_NavPropsMyHealth")]
    partial class NavPropsMyHealth
    {
            ...
            modelBuilder.Entity("eDoc.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("MyBloodPressureId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("MyDoctorId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MyWeightID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("MyBloodPressureId");

                    b.HasIndex("MyWeightID");
            ...
            modelBuilder.Entity("eDoc.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("eDoc.Data.Models.MyBloodPressure", "MyBloodPressure")
                        .WithMany()
                        .HasForeignKey("MyBloodPressureId");

                    b.HasOne("eDoc.Data.Models.MyWeight", "MyWeight")
                        .WithMany()
                        .HasForeignKey("MyWeightID");
